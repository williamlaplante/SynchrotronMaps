...
path = "../computations/out/cross_corr/"

print('Setting up plotting parameters...')

figure, axes = plt.subplots(nrows=2, ncols=4, figsize=(20,8), sharex=True)
figure.suptitle('Cross-correlation of LSS maps with dust maps for different z-ranges.')
...
figure.savefig('../results/cross_corr_by_z.%d.jpg' % time.time(), format='jpeg')
